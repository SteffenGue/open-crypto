...
class Ticker(Base):
    ...
    response_time: DateTime
        ...
        Timestamps are equal for each exchange for one run through (resulting in an error of approx. 5 seconds average)
    ...
    response_time = Column(DateTime, primary_key=False, unique=False)
